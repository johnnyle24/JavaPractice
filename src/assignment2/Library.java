...
public class Library {
	...
	// Creates an array called library that can only be accessed within this class. Typecasts it with librarybook.
	...
	// Adds another library book with parameter inputs into the library array list.
